...
def main():
    ...
    qsetting = QtCore.QSettings(util.getIniFile(),1)
    test = cmsRunProcess("makePatTuple")
    qsetting.beginGroup("myCmsRunConf")
    test.generateCmsRunConf(qsetting)
#    test.start()
#    test.waitForFinished(99999999)
