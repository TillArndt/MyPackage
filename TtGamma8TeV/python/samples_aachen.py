...
class Run2012Arecover06Aug2012(smp.Sample):
    ...
    cfg_builtin = {"sample":"recover06Aug2012"}
...
class Run2012B13Jul2012(smp.Sample):
    ...
    #lumi= 4446 #pixelLumi
    lumi= 4429 #lumiCalc2
    cfg_builtin = {"sample":"Run2012B-13Jul2012"}
...
class Run2012CEcalRecover11Dec2012(smp.Sample):
    ...
    cfg_builtin = {"sample":"Run2012C-EcalRecover_11Dec2012"}
...
class Run2012C24AugSynch(smp.Sample):
    ...
    cfg_builtin = {"sample":"Run2012C-24AugSynch"}
...
class Run2012CPromptRecov2(smp.Sample):
    ...
    #lumi= #pixelLumi
    lumi= 6392. #lumiCalc2
    cfg_builtin = {"sample":"Run2012C-PromptReco-v2"}
...
class Run2012DPromptRecov1(smp.Sample):
    ...
    #lumi= #pixelLumi
    lumi=  6689. #lumiCalc2
    cfg_builtin = {"sample":"Run2012D-PromptReco-v1"}
