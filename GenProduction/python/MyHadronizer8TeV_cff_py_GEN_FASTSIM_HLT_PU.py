...
# with command line options: MyPackage/GenProduction/python/MyHadronizer8TeV_cff.py -s GEN,FASTSIM,HLT:GRun --conditions=FrontierConditions_GlobalTag,START53_V14::All --pileup=2012_Summer_inTimeOnly --eventcontent=AODSIM --filetype=LHE --filein=file:/NON_EXISTENT --fileout=file:/NON_EXISTENT -n -1 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:/NON_EXISTENT')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MyPackage/GenProduction/python/MyHadronizer8TeV_cff.py nevts:-1'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/NON_EXISTENT'),
